...
@interface WWLrcView () <UITableViewDataSource, UITableViewDelegate>
...
{
    if (_lrcLines == nil) {
        _lrcLines = [WWLrcLine lrcLinesWithFileName:self.fileName];
    }
    return _lrcLines;
}
...
{
    WWLrcCell *cell = [WWLrcCell lrcCellWithTableView:tableView];
